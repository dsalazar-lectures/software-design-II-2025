...
El patrón Object Pool es un patrón de diseño de software **creacional** que consiste en mantener un **conjunto de objetos ya inicializados** y listos para su uso, en lugar de crearlos y destruirlos continuamente. Pertenece a la categoría de patrones creacionales porque se enfoca en el proceso de creación y gestión del ciclo de vida de objetos.
...
· Los objetos deben ser reseteados a su estado inicial cuando se devuelven al pool
...
· Recursos gráficos - Fuentes, imágenes o buffers de memoria
